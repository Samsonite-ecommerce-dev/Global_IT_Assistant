...
namespace GlobalIT.APP.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public HomeController(IBaseService baseService, IHomeService homeService, IUsersService usersService, appEntities appEntities, logEntities logEntities) : base(baseService)
        {
        ...
        public JsonResult LanguageConfig_Info()
        {
            ...
            {
                //语言包集合
                languageList = _baseService.LanguageTypeConfigOption().Select(p => new
                {
                    label = p.LanguageName,
                    value = p.ID
                }).ToList(),
                //当前默认语言
                languageType = _baseService.CurrentLanguageType
            });
        }
