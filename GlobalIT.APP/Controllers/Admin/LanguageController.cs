...
namespace GlobalIT.APP.Controllers
{
    public class LanguageController : BaseController
    {
        ...
        public LanguageController(IBaseService baseService, ILanguageService languageService, appEntities appEntities) : base(baseService)
        {
        ...
        public JsonResult Initialize_Info(string type, int id)
        {
            ...
            var _languageList = _baseService.LanguageTypeConfigOption().Select(o => new DefineSelectOption() { Label = o.LanguageName, Value = o.ID });
            ...
            else if (type == "edit")
            {
                ...
                if (objLanguagePackKey != null)
                {
                    ...
                    //语言包配置列表
                    var languages = _baseService.LanguageTypeConfigOption();
        ...
        public JsonResult Reset_Message()
        {
            ...
            try
            {
                _baseService.ResetLanguagePackCache();
                //返回信息
                return Json(new
                {
                    result = true,
