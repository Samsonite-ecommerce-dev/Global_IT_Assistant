...
namespace Samsonite.Library.Web.Core
{
    public class UploadService : IUploadService
    {
        ...
        public UploadService(IBaseService baseService, IHostEnvironment hostEnvironment, appEntities appEntities)
        {
        ...
        public QueryResponse<UploadFileCollection> GetQuery(UploadSearchRequest request)
        {
            ...
            string _directoryPath = _baseService.CurrentApplicationConfig.GlobalConfig.UploadFilePath;
