...
namespace Samsonite.Library.Web.Business.Basic
{
    public class ServiceConfigService : IServiceConfigService
    {
        ...
        public ServiceConfigService(IBaseService baseService, appEntities appEntities)
        {
        ...
        public PostResponse Add(ServiceConfigAddRequest request)
        {
            try
            {
                ...
                _appDB.SaveChanges();
                //添加日志
                _baseService.InsertLog<ServiceModuleInfo>(objData, objData.ModuleID.ToString());
                //返回信息
        ...
        public PostResponse Edit(ServiceConfigEditRequest request)
        {
            try
            {
                ...
                if (objData != null)
                {
                    ...
                    //添加日志
                    _baseService.UpdateLog<ServiceModuleInfo>(objData, objData.ModuleID.ToString());
                    //返回信息
                    return new PostResponse()
                    {
                        Result = true,
        ...
        public PostResponse OperDelete(long[] ids)
        {
            try
            {
                ...
                _appDB.SaveChanges();
                //添加日志
                _baseService.DeleteLog("ServiceModuleJob", string.Join(",", ids));
                //返回信息
                return new PostResponse
                {
                    Result = true,
