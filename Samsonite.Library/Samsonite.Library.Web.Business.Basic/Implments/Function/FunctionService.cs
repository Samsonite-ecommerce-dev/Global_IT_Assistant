...
namespace Samsonite.Library.Web.Business.Basic
{
    public class FunctionService : IFunctionService
    {
        ...
        public FunctionService(IBaseService baseService, appEntities appEntities)
        {
        ...
        public PostResponse Add(FunctionAddRequest request)
        {
            try
            {
                ...
                _appDB.SaveChanges();
                //添加日志
                _baseService.InsertLog<SysFunction>(objData, objData.Funcid.ToString());
                //返回信息
        ...
        public PostResponse Edit(FunctionEditRequest request)
        {
            try
            {
                ...
                if (objData != null)
                {
                    ...
                    _appDB.SaveChanges();
                    //添加日志
                    _baseService.UpdateLog<SysFunction>(objData, objData.Funcid.ToString());
                    //返回信息
                    return new PostResponse()
                    {
                        Result = true,
        ...
        public PostResponse Delete(int[] ids)
        {
            try
            {
                ...
                _appDB.SaveChanges();
                //添加日志
                _baseService.DeleteLog("SysFunction", string.Join(",", ids));
                //返回信息
                return new PostResponse
                {
                    Result = true,
