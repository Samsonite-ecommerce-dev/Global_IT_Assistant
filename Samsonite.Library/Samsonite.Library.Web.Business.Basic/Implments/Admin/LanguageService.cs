...
namespace Samsonite.Library.Web.Business.Basic
{
    public class LanguageService : ILanguageService
    {
        ...
        public LanguageService(IBaseService baseService, IFunctionGroupService functionGroupService, IFunctionService functionService, appEntities appEntities)
        {
            ...
            using (var Trans = _appDB.Database.BeginTransaction())
            {
                try
                {
                    ...
                    if (objData != null)
                    {
                        ...
                        _appDB.SaveChanges();
                        //编辑日志
                        _baseService.UpdateLog<LanguagePackKey>(objData, objData.ID.ToString());
                    }
                    Trans.Commit();
                    //返回信息
                    return new PostResponse()
        ...
        public PostResponse Delete(long[] ids)
        {
            ...
            try
            {
                ...
                _appDB.SaveChanges();
                //添加日志
                _baseService.DeleteLog("LanguagePackKey", string.Join(",", ids));
                //返回信息
                return new PostResponse()
                {
                    Result = true,
        ...
        public PostResponse Restore(long[] ids)
        {
            ...
            try
            {
                ...
                _appDB.SaveChanges();
                //添加日志
                _baseService.RestoreLog("LanguagePackKey", string.Join(",", ids));
                //返回信息
                return new PostResponse()
                {
                    Result = true,
