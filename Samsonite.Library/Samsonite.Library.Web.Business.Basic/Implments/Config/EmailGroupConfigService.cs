...
namespace Samsonite.Library.Web.Business.Basic
{
    public class EmailGroupConfigService : IEmailGroupConfigService
    {
        ...
        public EmailGroupConfigService(IBaseService baseService, appEntities appEntities)
        {
        ...
        public PostResponse Add(EmailGroupConfigAddRequest request)
        {
            try
            {
                ...
                _appDB.SaveChanges();
                //添加日志
                _baseService.InsertLog<SendMailGroup>(objData, objData.ID.ToString());
                //返回信息
        ...
        public PostResponse Edit(EmailGroupConfigEditRequest request)
        {
            try
            {
                ...
                if (objData != null)
                {
                    ...
                    _appDB.SaveChanges();
                    //添加日志
                    _baseService.UpdateLog<SendMailGroup>(objData, objData.ID.ToString());
                    //返回信息
                    return new PostResponse()
                    {
                        Result = true,
        ...
        public PostResponse Delete(int[] ids)
        {
            try
            {
                ...
                _appDB.SaveChanges();
                //添加日志
                _baseService.DeleteLog("SendMailGroup", string.Join(",", ids));
                //返回信息
                return new PostResponse
                {
                    Result = true,
