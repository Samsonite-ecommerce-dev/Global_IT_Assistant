...
namespace Samsonite.Library.Web.Business.Basic
{
    public class UploadConfigService : IUploadConfigService
    {
        ...
        public UploadConfigService(IBaseService baseService, appEntities appEntities)
        {
        ...
        public PostResponse Add(UploadConfigAddRequest request)
        {
            try
            {
                ...
                _appDB.SaveChanges();
                //添加日志
                _baseService.InsertLog<SysUploadModel>(objData, objData.ID.ToString());
                //返回信息
        ...
        public PostResponse Edit(UploadConfigEditRequest request)
        {
            try
            {
                ...
                if (objData != null)
                {
                    ...
                    _appDB.SaveChanges();
                    //添加日志
                    _baseService.UpdateLog<SysUploadModel>(objData, objData.ID.ToString());
                    //返回信息
                    return new PostResponse()
                    {
                        Result = true,
        ...
        public PostResponse Delete(int[] ids)
        {
            try
            {
                ...
                _appDB.SaveChanges();
                //添加日志
                _baseService.DeleteLog("SysUploadModel", string.Join(",", ids));
                //返回信息
                return new PostResponse
                {
                    Result = true,
